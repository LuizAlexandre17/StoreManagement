package br.com.secharpe.util.view;
...
public class DMessage extends javax.swing.JDialog {
    ...
    public DMessage(String message, String title, int icon) throws java.io.IOException {
        new br.com.secharpe.util.Log().put("DMessage", "Abrindo janela");
        initComponents();
        ImageIcon image = null;
        switch (icon) {
            case 1: //info
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "info.png"));
                jpBackground.setBackground(Color.blue);
                break;
            case 2: //warn
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "warning.png"));
                jpBackground.setBackground(Color.orange);
                break;
            case 3: //settings
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "settings.png"));
                jpBackground.setBackground(Color.blue);
                break;
            case 4: //plus
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "plus.png"));
                jpBackground.setBackground(Color.blue);
                break;
            case 5:
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "export.png"));
                jpBackground.setBackground(Color.green);
                break;
            case 6:
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "/import.png"));
                jpBackground.setBackground(Color.green);
                break;
            case 7:
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "like.png"));
                jpBackground.setBackground(Color.green);
                break;
            case 8:
                image = new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "error.png"));
                jpBackground.setBackground(Color.red);
                break;
            default:
        }

        jlOk.setIcon(new ImageIcon(getClass().getResource(Vars.PATH_TO_ICON_FOLDER + "check64.png")));
