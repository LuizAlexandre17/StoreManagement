...
public final class MessageCtrl {
    ...
    private static final br.com.secharpe.util.Log log = new br.com.secharpe.util.Log();
    ...
    public static void callMessage(String mensagem, String titulo, int iconType) {
        try {
            br.com.secharpe.util.view.DMessage message = new br.com.secharpe.util.view.DMessage(mensagem, titulo, iconType);
